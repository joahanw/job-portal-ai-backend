...
public class ApplicationDomainService implements IApplicationDomainService {
    ...
    public Application getById(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new CustomException(
                        ...
                        String.format(AppConstant.Error.TITLE_NOT_FOUND, "Application"),
                        String.format(AppConstant.Error.MESSAGE_NOT_FOUND, "Application", id)
                ));
    }
}
